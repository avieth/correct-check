...
{-# INLINE quickCheck #-}
quickCheck :: Word32 -> t -> Property state space dynamic result refutation t -> IO (QuickCheck space dynamic refutation)
quickCheck n t prop = newSeedIO <&> quickCheckAt n t prop

{-# INLINE quickCheckParallel #-}
quickCheckParallel :: Word32 -> Word32 -> t -> Property state space dynamic result refutation t -> IO (QuickCheck space dynamic refutation)
...
data QuickCheck space dynamic refutation where
  Passed :: Word32 -> Seed -> QuickCheck space dynamic refutation
  ...
  Failed :: Word32 -> Seed -> Counterexample space dynamic refutation -> QuickCheck space dynamic refutation
